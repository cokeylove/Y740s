...
extern void Cmd_B5(BYTE nPort);//Y7JERRY091¡êoAdd workaround for hang S4/cold boot/reboot.
extern void Cmd_B6(BYTE nPort);//Y7JERRY091¡êo Add workaround for hang S4/cold boot/reboot.

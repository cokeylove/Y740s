...
*********************************************************
*/
#define  Ucsi_version          UCSI_RAM0             //_at_ OEMRAM4+0x20;				// PPM -> OPM
#define  Ucsi_reserved0        UCSI_RAM1             //_at_ OEMRAM4+0x22;
#define  Ucsi_cci			         UCSI_RAM2             //_at_ OEMRAM4+0x24~0x27; 	// PPM -> OPM: USB Type-C Command Status and Connector Change Indication
...
#define  Ucsi_control					 UCSI_RAM3             //_at_ OEMRAM4+0x28~0x2F;	// OPM -> PPM
...
#define  Ucsi_message_in       UCSI_RAM4             //_at_ OEMRAM4+0x30~0x3F;	// PPM -> OPM
#define  Ucsi_message_out      UCSI_RAM5             //_at_ OEMRAM3+0x40~0x4F;	// OPM -> PPM
//#define  Ucsi_message_ou      UCSI_RAM6             //_at_ OEMRAM3+0xA0~0xAF;	// OPM -> PPM
//#define  Ucsi_message_o      UCSI_RAM7             //_at_ OEMRAM3+0xA0~0xAF;	// OPM -> PPM
/*
*********************************************************
*     #define Constants
*********************************************************
...
#define _SUPPORT_PDO_DETAIL_				0 //TODO
#define _SUPPORT_CABLE_DETAILS_				1 //TODO
...
#define UCSI_BM_ATTRIBUTES_POWER_SOURCE_AC_SUPPLY                        BIT0//(1 << 8)
#define UCSI_BM_ATTRIBUTES_POWER_SOURCE_OTHER                            BIT2//(1 << 10)
...
#define UCSI_CONNECTOR_RESET_COMMAND_CONNECTOR_NUMBER                    (Ucsi_control[2] & 0x7F)	//Control bit16~22
...
#define UCSI_GET_CAPABILITY_DATA_BM_ATTRIBUTES                           ((LWORD)(Ucsi_message_in[3]<<24) + (Ucsi_message_in[2]<<16) + (Ucsi_message_in[1]<<8) + Ucsi_message_in[0])	//Ucsi_message_in bit0~31
#define UCSI_GET_CAPABILITY_DATA_B_NUM_CONNECTOR                         (Ucsi_message_in[4] & 0x7F)	//Ucsi_message_in bit32~38
#define UCSI_GET_CAPABILITY_DATA_BM_OPTION_FEATURES                      ((LWORD)(Ucsi_message_in[7]<<16) + (Ucsi_message_in[6]<<8) + Ucsi_message_in[5])	//Ucsi_message_in bit40~63
#define UCSI_GET_CAPABILITY_DATA_B_NUM_ALT_MODES                         ((Ucsi_message_in[7]<<2)+(Ucsi_message_in[6]>>6))	//Ucsi_message_in bit54~61?64~71?
#define UCSI_GET_CAPABILITY_DATA_BCD_BC_VERSION                          ((WORD)(Ucsi_message_in[11]<<8) + Ucsi_message_in[10])	//Ucsi_message_in bit80~95
#define UCSI_GET_CAPABILITY_DATA_BCD_PD_VERSION                          ((WORD)(Ucsi_message_in[13]<<8) + Ucsi_message_in[12])	//Ucsi_message_in bit96~111
#define UCSI_GET_CAPABILITY_DATA_BCD_USB_TYPE_C_VERSION                  ((WORD)(Ucsi_message_in[15]<<8) + Ucsi_message_in[14])	//Ucsi_message_in bit112~127
...
#define UCSI_GET_CONNECTOR_CAPABILITY_COMMAND_CONNECTOR_NUMBER           (Ucsi_control[2] & 0x7F)	//Control bit16~22
...
#define UCSI_SET_UOM_COMMAND_CONNECTOR_NUMBER                           (Ucsi_control[2] & 0x7F)	//Control bit16~22
...
#define UCSI_SET_UOR_COMMAND_CONNECTOR_NUMBER                            (Ucsi_control[2] & 0x7F)	//Control bit16~22
...
#define UCSI_SET_PDM_COMMAND_CONNECTOR_NUMBER                            (Ucsi_control[2] & 0x7F)	//Control bit16~22
...
#define UCSI_SET_PDR_COMMAND_CONNECTOR_NUMBER                            (Ucsi_control[2] & 0x7F)	//Control bit16~22
...
#define UCSI_GET_ALTERNATE_MODES_COMMAND_CONNECTOR_NUMBER                	(Ucsi_control[3] & 0x7F)// bit24~30
...
#define UCSI_GET_CAM_SUPPORT_COMMAND_CONNECTOR_NUMBER                            (Ucsi_control[2] & 0x7F)	//Control bit16~22

#define UCSI_GET_CURRENT_CAM_COMMAND_COMMAND                                     	// bit0~7
#define UCSI_GET_CURRENT_CAM_COMMAND_DATA_LENGTH                                 	// bit8~15
#define UCSI_GET_CURRENT_CAM_COMMAND_CONNECTOR_NUMBER                            (Ucsi_control[2] & 0x7F)	//Control bit16~22

#define UCSI_SET_NEW_CAM_COMMAND_COMMAND                                 	// bit0~7
#define UCSI_SET_NEW_CAM_COMMAND_DATA_LENGTH                             	// bit8~15
#define UCSI_SET_NEW_CAM_COMMAND_CONNECTOR_NUMBER                        	// bit16~22
#define UCSI_SET_NEW_CAM_COMMAND_ENTER_OR_EXIT                           	// bit23
#define UCSI_SET_NEW_CAM_COMMAND_NEW_CAM                                 	// bit24~31
#define UCSI_SET_NEW_CAM_COMMAND_AM_SPECIFIC                             	// bit32~63

#define UCSI_GET_PDOS_COMMAND_COMMAND                                    	// bit0~7
#define UCSI_GET_PDOS_COMMAND_DATA_LENGTH                                	// bit8~15
#define UCSI_GET_PDOS_COMMAND_CONNECTOR_NUMBER                           (Ucsi_control[2] & 0x7F)	//Control bit16~22
...
#define UCSI_GET_CABLE_PROPERTY_COMMAND_COMMAND                          	// bit0~7
#define UCSI_GET_CABLE_PROPERTY_COMMAND_DATA_LENGTH                      	// bit8~15
#define UCSI_GET_CABLE_PROPERTY_COMMAND_CONNECTOR_NUMBER                 	(Ucsi_control[2] & 0x7F)// bit16~22
#define UCSI_GET_CABLE_PROPERTY_DATA_BM_SPEED_SUPPORTED                  	// bit0~15
#define UCSI_GET_CABLE_PROPERTY_B_CURRENT_CAPABILITY                     	// bit16~23
#define UCSI_GET_CABLE_PROPERTY_VBUS_IN_CABLE                            	// bit24
#define UCSI_GET_CABLE_PROPERTY_CABLE_TYPE                               	// bit25
#define UCSI_GET_CABLE_PROPERTY_DIRECTIONALITY                           	// bit26
#define UCSI_GET_CABLE_PROPERTY_PLUG_END_TYPE                            	// bit27~28
#define UCSI_GET_CABLE_PROPERTY_MODE_SUPPORT                             	// bit29
#define UCSI_GET_CABLE_PROPERTY_LATENCY                                  	// bit32~35

#define UCSI_GET_CONNECTOR_STATUS_COMMAND_COMMAND                        	// bit0~7
#define UCSI_GET_CONNECTOR_STATUS_COMMAND_DATA_LENGTH                    	// bit8~15
#define UCSI_GET_CONNECTOR_STATUS_COMMAND_CONNECTOR_NUMBER               (Ucsi_control[2] & 0x7F)	//Control bit16~22
#define UCSI_GET_CONNECTOR_STATUS_DATA_CONNECTOR_STATUS_CHANGE           	// bit0~15
#define UCSI_GET_CONNECTOR_STATUS_DATA_POWER_OPERATION_MODE              (Ucsi_message_in[2] & 0x07)	//Ucsi_message_in bit16~18
...
#define UCSI_GET_CONNECTOR_STATUS_DATA_BATTERY_CHARGING_STATUS           (Ucsi_message_in[8] & 0x03)	//Ucsi_message_in bit64~65
...
//typedef struct _UCSI_DATA_STRUCTURE UCSI_DATA_STRUCTURE;

typedef enum {USB_PDC_REQ_NONE,
              ...
              USB_PDC_REQ_PPM_RESET,
              USB_PDC_REQ_SET_NOTIFICATION_ENABLE,
              USB_PDC_REQ_GET_CAPABILITY,
              USB_PDC_REQ_GET_CONNECTOR_CAPABILITY,
              USB_PDC_REQ_GET_PDO,
              USB_PDC_REQ_SWAP_TO_SINK,
              USB_PDC_REQ_SWAP_TO_SOURCE,
              USB_PDC_REQ_SWAP_TO_ACCEPT_SOURCE_SINK,
              USB_PDC_REQ_SWAP_TO_UFP,
              USB_PDC_REQ_SWAP_TO_DFP,
              USB_PDC_REQ_SWAP_TO_DRP,
              USB_PDC_REQ_OPERATE_AS_DFP,
              USB_PDC_REQ_OPERATE_AS_UFP,
              USB_PDC_REQ_OPERATE_AS_DRP,
              USB_PDC_REQ_OPERATE_AS_SOURCE,
              USB_PDC_REQ_OPERATE_AS_SINK,
              USB_PDC_REQ_OPERATE_AS_ACCEPT_SOURCE_SINK,
              USB_PDC_REQ_GET_ALTERNATE_MODES,
              USB_PDC_REQ_GET_CAM_SUPPORTED,
              USB_PDC_REQ_GET_CURRENT_CAM,
              USB_PDC_REQ_GET_CABLE_PROPERTY,
...
extern void UcsiUsbPdcStatusChanged(USB_POWER_STATUS power_status, USB_STATUS status);
extern void UcsiFuelStateChanged(BYTE state);
#endif
#endif

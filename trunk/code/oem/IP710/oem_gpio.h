...
//-----------------------------------------------------------------
#define PortA_Init		0x8f            // PORT Data 	

#define PortA0_Ctrl		OUTPUT			//O   24  	PWR_LED#
#define PortA1_Ctrl		OUTPUT			//O   25    PWR_LED2# 
...
#define PortA7_Ctrl		OUTPUT	        //O   34    BATT_CHG_LED# 
...
//add A cover LED control
#define PWR_A_COVER_LED_ON()		SET_MASK(GPDRA,BIT(1))
#define PWR_A_COVER_LED_OFF()		CLEAR_MASK(GPDRA,BIT(1))
#define PWR_A_COVER_LED_INVERSE()  	INVERSE_REG_MASK(GPDRA,BIT(1))

#define PWR_A_COVER_LED_ALT			GPCRA1 = ALT  
#define PWR_A_COVER_LED_OUTPUT		GPCRA1 = OUTPUT	
#define PWR_A_COVER_LED_INPUT		GPCRA1 = INPUT   
//
...
//#define Read_VCCIO_PG()	IS_MASK_SET(GPDRA,BIT(7))	
...
#define PortB5_Ctrl		OUTPUT			//O    126 	PCH_PWR_EN
...
//-----------------------------------------------------------------
#define PortD_Init		0x20            // PORT Data  //modify USB_ON# default to high.

#define PortD0_Ctrl		INPUT			//I      18		PM_SLP_S3#
#define PortD1_Ctrl		OUTPUT			//O      21		EC_ON_1V
...
#define PortF5_Ctrl		INPUT 			//I     90  	VCCIO_PG 
...
#define EC_TP_ON_HI()           SET_MASK(GPDRF,BIT(4)) 		//Add enable/disable touchpad function by HW pin.
#define EC_TP_ON_LOW()         	CLEAR_MASK(GPDRF,BIT(4)) 	//Add enable/disable touchpad function by HW pin.
#define READ_EC_TP_ON()         IS_MASK_SET(GPDRF,BIT(4))	//Add enable/disable touchpad function by HW pin.

#define Read_VCCIO_PG()			IS_MASK_SET(GPDRF,BIT(5))			
...
//-----------------------------------------------------------------
#define PortG_Init		0x01            // PORT Data   //modify VGA_AC_DET defalut to high. 
...
#define Read_EC_ON_5V_ON()		IS_MASK_SET(GPDRH,BIT(7)) 			
...
#define PortJ7_Ctrl		INPUT          	//O    	2 	PCIE_WAKE# //Modify PCIE_WAKE initial control values to leakage.

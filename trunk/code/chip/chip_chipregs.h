...
/* Cache Disabled Register */
#define	CACHDISR		ECReg(EC_Register_Base_Address+0x1033)
...
/* Security Host View Block Mode Select [15:8] */
#define SHVBMSH       	ECReg(EC_Register_Base_Address+0x106B)

/* Security Host View Block Mode Select [7:0] */
#define SHVBMSL       	ECReg(EC_Register_Base_Address+0x106C)
...
/* Flash Control 5 Register */
#define FLHCTRL5R       ECReg(EC_Register_Base_Address+0x1080)

/* Flash Control 4 Register */
#define FLHCTRL6R       ECReg(EC_Register_Base_Address+0x1081)

/* Scratch SRAM SMBus Address Low Byte Register */
#define SCARSL          ECReg(EC_Register_Base_Address+0x109F)

/* Static DMA Control Register */
#define STCDMACR		ECReg(EC_Register_Base_Address+0x10B0)
...
#define	Int_PS2_1	    BIT(3)  // INT19    // PS/2 Interrupt 1
...
#define	Int_EXTimer	    BIT(6)  // INT30    // External Timer Interrupt
...
// IER5
//#define   Int_	    BIT(0)  // INT40    // -
//#define	Int_	    BIT(1)  // INT41    // -
//#define	Int_	    BIT(2)  // INT42    // -
//#define	Int_        BIT(3)  // INT43    // -
//#define	Int_        BIT(4)  // INT44    // -
//#define	Int_	    BIT(5)  // INT45    // -
//#define	Int_	    BIT(6)  // INT46    // -
//#define	Int_	    BIT(7)  // INT47    // -
...
#define Int_WKO106      BIT(7)  // INT111   // WKO[106]
...
// IER17
//#define   Int_	    BIT(0)  // INT136   // -
//#define	Int_	    BIT(1)  // INT137   // -
//#define	Int_	    BIT(2)  // INT138   // -
//#define	Int_        BIT(3)  // INT139   // -
//#define	Int_        BIT(4)  // INT140   // -
//#define	Int_	    BIT(5)  // INT141   // -
//#define	Int_	    BIT(6)  // INT142   // -
//#define	Int_	    BIT(7)  // INT143   // -
...
#define Int_WKO127      BIT(4)  // INT148   // WKO[127]
...
// IER19
#define Int_PECI	    BIT(0)  // INT152   // PECI Interrupt
#define	Int_eSPI	    BIT(1)  // INT153   // eSPI Interrupt
#define	Int_eSPIVW      BIT(2)  // INT154   // eSPI VW Interrupt
#define	Int_Port80      BIT(3)  // INT155   // Port 80h/81h Interrupt
#define	Int_OSCDMA      BIT(4)  // INT156   // OSC DMA Interrupt
#define	Int_ET3Intr	    BIT(5)  // INT157   // External Timer 3 Interrupt
#define	Int_SWIntr	    BIT(6)  // INT158   // Software Interrupt
#define	Int_PLLIntr	    BIT(7)  // INT159   // PLL Change Interrupt
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
...
/* Port Control H7 Registers */
#define GPCRH7			ECReg(EC_Register_Base_Address+0x164F)
...
/* ELPM Register */
#define ELPMCTL         ECReg(EC_Register_Base_Address+0x16E3)
/* 
 * ****************************************************************************
...
//REJERRY007:S+ add PWM0 dimming control register.
#define PWM0LHE         ECReg(EC_Register_Base_Address+0x1850)//PWM0 LED Dimming enable register 
#define DIMMING_ENABLE  BIT(0)

#define PWM0LCR1        ECReg(EC_Register_Base_Address+0x1851)//PWM0 LED Dimming control register1  
#define PWM0LCR2        ECReg(EC_Register_Base_Address+0x1852)//PWM0 LED Dimming control register2
//REJERRY007:E+ add PWM0 dimming control register.
...
/* ADC Input Voltage Mapping Full-Scale Code Selection - default : 0x00 convert 0v ~ 3.0v to 0h ~ 3FFh */
#define ADCIVMFSCS1     ECReg(EC_Register_Base_Address+0x1955)
 ...
 */
/* Host Status A */
#define	HOSTA_A      	ECReg(EC_Register_Base_Address+0x1C00)

/* Host Status B */
#define	HOSTA_B      	ECReg(EC_Register_Base_Address+0x1C11)

/* Host Status C */
#define	HOSTA_C      	ECReg(EC_Register_Base_Address+0x1C29)

/* Host Status D */
#define	HOSTA_D      	ECReg(EC_Register_Base_Address+0x1C35)
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
...
/* Host Control A */
#define	HOCTL_A       	ECReg(EC_Register_Base_Address+0x1C01)

/* Host Control B */
#define	HOCTL_B       	ECReg(EC_Register_Base_Address+0x1C12)

/* Host Control C */
#define	HOCTL_C       	ECReg(EC_Register_Base_Address+0x1C2A)

/* Host Control D */
#define	HOCTL_D       	ECReg(EC_Register_Base_Address+0x1C36)
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
...
/* Host Command A */
#define	HOCMD_A       	ECReg(EC_Register_Base_Address+0x1C02)
//#define CHSEF           ECReg(EC_Register_Base_Address+0x1C11)  // Channel Select EF Register


/* Host Command B */
#define	HOCMD_B       	ECReg(EC_Register_Base_Address+0x1C13)
//#define CHSAB           ECReg(EC_Register_Base_Address+0x1C20) //Channel select AB register
//#define CHSCD           ECReg(EC_Register_Base_Address+0x1C21) //channel select CD register

/* Host Command C */
#define	HOCMD_C       	ECReg(EC_Register_Base_Address+0x1C2B)

/* Host Command D */
#define	HOCMD_D       	ECReg(EC_Register_Base_Address+0x1C37)

/* Transmit Slave Address A */
#define	TRASLA_A      	ECReg(EC_Register_Base_Address+0x1C03)

/* Transmit Slave Address B */
#define	TRASLA_B      	ECReg(EC_Register_Base_Address+0x1C14)

/* Transmit Slave Address C */
#define	TRASLA_C      	ECReg(EC_Register_Base_Address+0x1C2C)

/* Transmit Slave Address D */
#define	TRASLA_D      	ECReg(EC_Register_Base_Address+0x1C38)

/* Host Data 0 A */
#define	D0REG_A       	ECReg(EC_Register_Base_Address+0x1C04)

/* Host Data 0 B */
#define	D0REG_B       	ECReg(EC_Register_Base_Address+0x1C15)

/* Host Data 0 C */
#define	D0REG_C       	ECReg(EC_Register_Base_Address+0x1C2D)

/* Host Data 0 D */
#define	D0REG_D       	ECReg(EC_Register_Base_Address+0x1C39)

/* Host Data 1 A */
#define	D1REG_A       	ECReg(EC_Register_Base_Address+0x1C05)

/* Host Data 1 B */
#define	D1REG_B      	ECReg(EC_Register_Base_Address+0x1C16)

/* Host Data 1 C */
#define	D1REG_C      	ECReg(EC_Register_Base_Address+0x1C2E)

/* Host Data 1 D */
#define	D1REG_D      	ECReg(EC_Register_Base_Address+0x1C3A)

/* Host Block Data Byte A */
#define	HOBDB_A       	ECReg(EC_Register_Base_Address+0x1C06)

/* Host Block Data Byte B */
#define	HOBDB_B        	ECReg(EC_Register_Base_Address+0x1C17)

/* Host Block Data Byte C */
#define	HOBDB_C        	ECReg(EC_Register_Base_Address+0x1C2F)

/* Host Block Data Byte D */
#define	HOBDB_D        	ECReg(EC_Register_Base_Address+0x1C3B)

/* Packet Error Check A */
#define	PECERC_A      	ECReg(EC_Register_Base_Address+0x1C07)

/* Packet Error Check B */
#define	PECERC_B    	ECReg(EC_Register_Base_Address+0x1C18)

/* Packet Error Check C */
#define	PECERC_C    	ECReg(EC_Register_Base_Address+0x1C30)

/* Packet Error Check D */
#define	PECERC_D    	ECReg(EC_Register_Base_Address+0x1C3C)

/* Receive Slave Adress A */
#define	RESLADR_A		ECReg(EC_Register_Base_Address+0x1C08)

/* Receive Slave Adress B */
#define	RESLADR_B		ECReg(EC_Register_Base_Address+0x1C19)

/* Receive Slave Adress_2 A */
#define	RESLADR_2_A		ECReg(EC_Register_Base_Address+0x1C3F)

/* Receive Slave Adress_2 B */
#define	RESLADR_2_B		ECReg(EC_Register_Base_Address+0x1C44)

/* Slave Data A */
#define	SLDA_A			ECReg(EC_Register_Base_Address+0x1C09)

/* Slave Data B */
#define	SLDA_B			ECReg(EC_Register_Base_Address+0x1C1A)

/* SMBUS Pin Control A */
#define	SMBPCTL_A      	ECReg(EC_Register_Base_Address+0x1C0A)

/* SMBUS Pin Control B */
#define	SMBPCTL_B      	ECReg(EC_Register_Base_Address+0x1C1B)

/* SMBUS Pin Control C */
#define	SMBPCTL_C      	ECReg(EC_Register_Base_Address+0x1C31)

/* SMBUS Pin Control D */
#define	SMBPCTL_D      	ECReg(EC_Register_Base_Address+0x1C3D)

/* Slave Status A */
#define	SLSTA_A			ECReg(EC_Register_Base_Address+0x1C0B)

/* Slave Status B */
#define	SLSTA_B			ECReg(EC_Register_Base_Address+0x1C1C)
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
...
#define	SICR_A			ECReg(EC_Register_Base_Address+0x1C0C)

/* Slave Interrupt Control B */
#define	SICR_B			ECReg(EC_Register_Base_Address+0x1C1D)

/* Notify Device Adress A */
#define	NDADR_A			ECReg(EC_Register_Base_Address+0x1C0D)

/* Notify Device Adress B */
#define	NDADR_B			ECReg(EC_Register_Base_Address+0x1C1E)

/* Notify Data Low Byte A */
#define	NDLB_A			ECReg(EC_Register_Base_Address+0x1C0E)

/* Notify Data Low Byte B */
#define	NDLB_B			ECReg(EC_Register_Base_Address+0x1C1F)

/* Notify Data High Byte A */
#define	NDHB_A			ECReg(EC_Register_Base_Address+0x1C0F)

/* Notify Data High Byte B */
#define	NDHB_B			ECReg(EC_Register_Base_Address+0x1C20)

/* Host Control2 A */
#define	HOCTL2_A      	ECReg(EC_Register_Base_Address+0x1C10)

/* Host Control2 B */
#define	HOCTL2_B      	ECReg(EC_Register_Base_Address+0x1C21)

/* Host Control2 C */
#define	HOCTL2_C      	ECReg(EC_Register_Base_Address+0x1C32)

/* Host Control2 D */
#define	HOCTL2_D      	ECReg(EC_Register_Base_Address+0x1C3E)

/* 4.7 £gs Low Register */
#define	SMB4P7USL   	ECReg(EC_Register_Base_Address+0x1C22)

/* 4.7 £gs High Register */
#define	SMB4P0USH   	ECReg(EC_Register_Base_Address+0x1C23)

/* 300 ns Register */
#define	SMB300NS  		ECReg(EC_Register_Base_Address+0x1C24)

/* 250 ns Register */
#define	SMB250NS  		ECReg(EC_Register_Base_Address+0x1C25)

/* 25 ms Register */
#define	SMB25MS   		ECReg(EC_Register_Base_Address+0x1C26)

/* 45.3 £gs Low Register */
#define	SMB45P3USL 		ECReg(EC_Register_Base_Address+0x1C27)

/* 45.3 £gs High Register */
#define	SMB45P3USH 		ECReg(EC_Register_Base_Address+0x1C28)

/* 4.7 £gs and 4.0 £gs High Register */
#define	SMB4P7A4P0H		ECReg(EC_Register_Base_Address+0x1C33)

/* Slave Interface Select */
#define	SLVISEL			ECReg(EC_Register_Base_Address+0x1C34)

/* SMCLK Timing Setting Register A */
#define	SCLKTS_A		ECReg(EC_Register_Base_Address+0x1C40)

/* SMCLK Timing Setting Register B */
#define	SCLKTS_B		ECReg(EC_Register_Base_Address+0x1C41)

/* SMCLK Timing Setting Register C */
#define	SCLKTS_C		ECReg(EC_Register_Base_Address+0x1C42)

/* SMCLK Timing Setting Register D */
#define	SCLKTS_D		ECReg(EC_Register_Base_Address+0x1C43)

/* SMbus FIFO Control 1 Register */
#define SMBFFCTRL1      ECReg(EC_Register_Base_Address+0x1C45)

/* SMBus FIFO Status 1 Register */
#define SMBFFSTS1       ECReg(EC_Register_Base_Address+0x1C46)

/* SMBus FIFO Control 2 Register */
#define SMBFFCTRL2      ECReg(EC_Register_Base_Address+0x1C47)

/* SMBus FIFO Status 2 Register */
#define SMBFFSTS2       ECReg(EC_Register_Base_Address+0x1C48)

/* HOST Nack Source A */
#define HONACKSRC_A     ECReg(EC_Register_Base_Address+0x1C49)

/* HOST Nack Source B */
#define HONACKSRC_B     ECReg(EC_Register_Base_Address+0x1C4A)

/* HOST Nack Source C */
#define HONACKSRC_C     ECReg(EC_Register_Base_Address+0x1C4B)

/* HOST Nack Source D */
#define HONACKSRC_D     ECReg(EC_Register_Base_Address+0x1C4C)

/* Slave FIFO Threshold */
#define SLVFTH          ECReg(EC_Register_Base_Address+0x1C4D)

/* Master FIFO Threshold */
#define MSTHTH          ECReg(EC_Register_Base_Address+0x1C4F)

/* Master FIFO Threshold Enable */
#define MFTHEN          ECReg(EC_Register_Base_Address+0x1C50)

/* Master FIFO Threshold Interrupt Status */
#define MFTISTA         ECReg(EC_Register_Base_Address+0x1C51)

/* Slave FIFO Threshold Enable */
#define SFTHEN          ECReg(EC_Register_Base_Address+0x1C58)

/* Slave FIFO Threshold Interrupt Status */
#define SFTISTA         ECReg(EC_Register_Base_Address+0x1C59)

/* Slave FIFO Control Register */
#define SFFCTL          ECReg(EC_Register_Base_Address+0x1C5E)

/* Slave FIFO Status */
#define SFFSTA          ECReg(EC_Register_Base_Address+0x1C5F)

/* I2C Wr to Rd FIFO Register */
#define I2CW2RF         ECReg(EC_Register_Base_Address+0x1C69)

/* I2C Wr to Rd FIFO Interrupt Status */
#define IWRFISTA        ECReg(EC_Register_Base_Address+0x1C6A)
...
#define ET3PSR          ECReg(EC_Register_Base_Address+0x1F10)

/* External Timer 3 Counter High Byte */
#define ET3CNTLHR       ECReg(EC_Register_Base_Address+0x1F11)

/* External Timer 3 Counter Low Byte */
#define ET3CNTLLR       ECReg(EC_Register_Base_Address+0x1F12)

/* External Timer 3 Counter High Byte 2 */
#define ET3CNTLH2R      ECReg(EC_Register_Base_Address+0x1F13)
...
#define EC201Ch   		ECReg(EC_Register_Base_Address+0x201C)
...
#define P80HDR           ECReg(EC_Register_Base_Address+0x2031)
#define P81HDR           ECReg(EC_Register_Base_Address+0x2032)
...
#define ELPMSTS         ECReg(EC_Register_Base_Address+0x2080)
/* 
 * ****************************************************************************
 ...
 * ****************************************************************************
 */
#define BRAM00			ECReg(EC_Register_Base_Address+0x2280)
#define BRAM01			ECReg(EC_Register_Base_Address+0x2281)
#define BRAM02			ECReg(EC_Register_Base_Address+0x2282)
#define BRAM03			ECReg(EC_Register_Base_Address+0x2283)
#define BRAM04			ECReg(EC_Register_Base_Address+0x2284)
#define BRAM05			ECReg(EC_Register_Base_Address+0x2285)
#define BRAM06			ECReg(EC_Register_Base_Address+0x2286)
#define BRAM07			ECReg(EC_Register_Base_Address+0x2287)
#define BRAM08			ECReg(EC_Register_Base_Address+0x2288)
#define BRAM09			ECReg(EC_Register_Base_Address+0x2289)
#define BRAM0A			ECReg(EC_Register_Base_Address+0x228A)
#define BRAM0B			ECReg(EC_Register_Base_Address+0x228B)
#define BRAM0C			ECReg(EC_Register_Base_Address+0x228C)
#define BRAM0D			ECReg(EC_Register_Base_Address+0x228D)
#define BRAM0E			ECReg(EC_Register_Base_Address+0x228E)
#define BRAM0F			ECReg(EC_Register_Base_Address+0x228F)

#define BRAM38			ECReg(EC_Register_Base_Address+0x22B8)
#define BRAM39			ECReg(EC_Register_Base_Address+0x22B9)
#define BRAM3A			ECReg(EC_Register_Base_Address+0x22BA)
#define b0USBChargerState BIT0    //MARTINH025:add

#define BRAM3B			ECReg(EC_Register_Base_Address+0x22BB)
#define BRAM3C			ECReg(EC_Register_Base_Address+0x22BC)
#define BRAM3D			ECReg(EC_Register_Base_Address+0x22BD)
#define BRAM3E			ECReg(EC_Register_Base_Address+0x22BE)
#define BRAM3F			ECReg(EC_Register_Base_Address+0x22BF)
 // ****************************************************************************
...
#define HOSTAR          ECReg(EC_Register_Base_Address+0x3000)
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
...
#define HOCTLR          ECReg(EC_Register_Base_Address+0x3001)
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
...
#define HOCMDR          ECReg(EC_Register_Base_Address+0x3002)

/* Host Target Address Register */
#define HOTRADDR        ECReg(EC_Register_Base_Address+0x3003)

/* Host Write Length Register */
#define HOWRLR          ECReg(EC_Register_Base_Address+0x3004)

/* Host Read Length Register */
#define HORDLR          ECReg(EC_Register_Base_Address+0x3005)

/* Host Write Data Register */
#define HOWRDR          ECReg(EC_Register_Base_Address+0x3006)

/* Host Read Data Register */
#define HORDDR          ECReg(EC_Register_Base_Address+0x3007)

/* Host Control 2 Register */
#define HOCTL2R         ECReg(EC_Register_Base_Address+0x3008)

/* Received Write FCS Value */
#define RWFCSV          ECReg(EC_Register_Base_Address+0x3009)

/* Received Read FCS Value */
#define RRFCSV          ECReg(EC_Register_Base_Address+0x300A)

/* Write FCS Value */
#define WFCSV           ECReg(EC_Register_Base_Address+0x300B)

/* Read FCS Falue */
#define RFCSV           ECReg(EC_Register_Base_Address+0x300C)

/* Assured Write FCS Value */
#define AWFCSV          ECReg(EC_Register_Base_Address+0x300D)

/* Pad Control Register */
#define PADCTLR         ECReg(EC_Register_Base_Address+0x300E)
